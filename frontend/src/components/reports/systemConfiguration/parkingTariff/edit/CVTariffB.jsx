...
/**
 * Props:
 * - title: string (e.g., "Tariff Setup for Car/Van(B)")
 * - initialSlots: optional default time slots
 */
export default function TariffSetupCarVanB({ title, initialSlots }) {
  ...
  const [rates, setRates] = useState(
    daysOfWeek.reduce((acc, day) => {
      acc[day] = initialSlots?.[day] ? [...initialSlots[day]] : [{ ...defaultSlot }];
      return acc;
    }, {})
  );
  ...
  const handleSave = () => {
    console.log(`${title} rates to save:`, rates);
    alert(`${title} rates saved!`);
  };
