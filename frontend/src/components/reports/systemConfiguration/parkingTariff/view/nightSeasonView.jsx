...
import { Home, Calendar, Clock, Eye, AlertCircle, Loader2, Moon } from "lucide-react";
import { toast } from "react-toastify";

export default function TariffSetupNightSeasonView() {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white border rounded-xl shadow-sm p-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Fetching Night Season configuration...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Tariff Setup for Night Season</h1>
