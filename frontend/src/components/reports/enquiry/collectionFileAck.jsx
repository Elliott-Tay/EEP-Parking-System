...
export default function CepasAckResultAnalysis() {
  ...
  const handleSearch = () => {
    ...
    alert(`Fetching CEPAS Analysis from ${startDate} to ${endDate} for report date ${reportDate}`);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-8">
      <h1 className="text-2xl font-bold mb-6">CEPAS Analysis of Acknowledge and Result File</h1>
