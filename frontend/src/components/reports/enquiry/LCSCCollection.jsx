...
export default function LcscCashcardComparison() {
  ...
  const handleSearch = () => {
    ...
    alert(`Fetching LCSC Cashcard Collection Comparison from ${startDate} to ${endDate} for report date ${reportDate}`);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-8">
      <h1 className="text-2xl font-bold mb-6">LCSC Cashcard Collection Comparison</h1>
