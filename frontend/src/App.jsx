...
function App() {
  ...
  const protectedRoutes = [
    ...
    { path: "/reports/station-errors", element: <StationErrorHistory />, requiredRole: "admin" },
    { path: "/reports/parking-charges-error", element: <ParkingChargeErrorHistory />, requiredRole: "admin" },
